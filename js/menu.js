...
export class Screens {
  ...
  bindMouse() {
    this.root.addEventListener('click', e => {
      ...
      else if (t.dataset.go != null) { if (this.current === 'car') { if (S.mode === 'cruise') { S.track = 'sanoozi'; this.go(); } else if (S.mode === 'race' && this.o.onMap) this.o.onMap(); else this.show('track'); } else this.go(); }
